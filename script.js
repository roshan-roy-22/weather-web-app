...
// function for the  background change  according to weather status
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/268917/pexels-photo-268917.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/531906/pexels-photo-531906.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(img/clear.jpg)';
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(https://images.pexels.com/photos/1903799/pexels-photo-1903799.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)';
    }
        ...
        // document.getElementById('parent').style.background = "linear-gradient(to right, red, green)";
    }
